            ...
            <li class="menu-header">Dashboard</li>
              ...
              <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a class="nav-link" href="form.kategorigallery.php">Form Kategori Gallery</a></li>
              ...
              <div class="card">
                <form action="../modal/modalKategoriGallery.php" method="post">
                  <div class="card-header">
                    <h4>Insert Kategori Gallery</h4>
                  </div>
                  <div class="card-body">
                    <div class="mb-3">
                      <label>Nama Kategori Gallery</label>
                      <input type="input" class="form-control" name="nama" placeholder="Masukkan Nama Kategori Gallery" required>
                    </div>
