          ...
          <ul class="sidebar-menu">
            <li class="menu-header">Dashboard</li>
              ...
              <!-- <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  <li class="active"><a class="nav-link" href="form.kategoriberita.php">Form Kategori Berita</a></li>
                ...
                <form action="../modal/modalKategoriBerita.php" method="post">
                  ...
                  <div class="card-body">
                    <div class="mb-3">
                      ...
                      <input type="input" class="form-control" name="nama" placeholder="Masukkan Nama Kategori Berita" required>
                    </div>
