            ...
            <li class="menu-header">Dashboard</li>
              ...
              <!-- <li class="nav-item dropdown active">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="active"><a class="nav-link" href="form.berita.php">Form Berita</a></li>
            ...
            <div class="col-12 col-md-12 col-lg-12">
              <div class="card">
                <form action="../modal/modalBerita.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-control" name="idkategori">
                        ...
                        ?>
                        <option value="<?php echo $a['id_kategori_berita']?>"><?php echo $a['nama_kategori_berita']?></option>
                        <?php endwhile; ?>
                      </select>
                    </div>
                    <div class="mb-3">
                      <label>Judul Berita</label>
                      <input type="input" class="form-control" placeholder="Masukkan Judul Berita" name="judul" required>
                    </div>
                    <div class="mb-3">
                      <label>Tanggal Post Berita</label>
                  ...
                  <div class="card-footer bg-whitesmoke br text-right">
