      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="form.gallery.php">Admin Page</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="form.gallery.php">Lab</a>
          </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-control" name="idkategori">
                        ...
                        ?>
                        <option value="<?php echo $a['id_kategori_gallery'];?>"><?php echo $a['nama_kategori_gallery'];?></option>
                        <?php endwhile;?>
                      </select>
                    </div>
                    <div class="mb-3">
                      <label>Caption Gallery</label>
                      <input type="input" class="form-control" name="caption" placeholder="Masukkan Caption Gallery" required>
                    </div>
                    <div class="mb-3">
                      <label>Tanggal Gallery</label>
                      <input type="date" class="form-control" name="tanggal" required>
                    </div>
                    <div class="mb-3">
                      <label>Deskripsi Gallery</label>
                      <input type="input" class="form-control" name="deskripsi" placeholder="Masukkan Deskripsi Gallery" required>
                    </div>
                  </div>
