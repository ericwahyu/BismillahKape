                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-md">
                      ...
                      <tr>
                        ...
                        <td class="d-flex m-2">
                          <a href="#" class="badge badge-warning mr-2" style="text-decoration:none" data-toggle="modal" data-target="#modalupdate<?php echo $a['id_halaman'];?>"><i class="fas fa-edit"></i>  Ubah</a>
                          <a href="#" class="badge badge-danger mr-2" style="text-decoration:none" data-confirm="Realy?|Anda yakin ingin menghapus data ini !" data-confirm-yes="window.location=' ../model/modelHalaman.php?id=<?php echo $a['id_halaman'];?>&delete&gambarlama=<?php echo $a['gambar_halaman'];?>'"><i class="fas fa-trash-alt"></i>  Hapus</a>
                          <a href="#" class="badge badge-success mr-2" style="text-decoration:none" data-toggle="modal" data-target="#modaldetail<?php echo $a['id_halaman'];?>"><i class="fas fa-info-circle"></i>  Detail</a>
                        </td>
                      </tr>
                      <?php $index++; endwhile;?>
                    </table>
